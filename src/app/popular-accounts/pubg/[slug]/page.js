...
const mockSelectedAccounts = {
    "pubg-royalpass-max-tier": {
        name: "اکانت رویال پس مکس پابجی",
        price: "2,800,000 تومان",
        oldPrice: "3,000,000 تومان",
        description: "اکانتی فوق‌العاده با اسکین‌های کمیاب، RP مکس‌شده و Tier بالا در پابجی موبایل.",
        images: [
            "/images/Gemini_Generated_Image_jd2makjd2makjd2m.jpeg",
            "/images/Gemini_Generated_Image_jd2makjd2makjd2m.jpeg",
            "/images/Gemini_Generated_Image_jd2makjd2makjd2m.jpeg",
            "/images/Gemini_Generated_Image_jd2makjd2makjd2m.jpeg",
        ],
