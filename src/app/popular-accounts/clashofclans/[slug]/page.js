...
const mockSelectedAccounts = {
    "th15-max-clash-account": {
        name: "اکانت مکس تاون هال 15 کلش آف کلنز",
        price: "4,500,000 تومان",
        oldPrice: "5,000,000 تومان",
        title: " اکانت تاون هال ۱۵ مکـس + سوپرسل آیدی متصل",
        description: "اکانتی حرفه‌ای با تاون‌هال ۱۵ مکس، نیروها و ساختمان‌ها فول و امنیت کامل.",
        images: [
            "/images/Gemini_Generated_Image_1fogf71fogf71fog.png",
            "/images/Gemini_Generated_Image_1fogf71fogf71fog.png",
            "/images/Gemini_Generated_Image_1fogf71fogf71fog.png",
            "/images/Gemini_Generated_Image_1fogf71fogf71fog.png",
        ],
        features: {
            ...
            adDate: "1403/05/06",
            accountLevel: "250",
            accountName: "ClasherX",
            TAG: "#Y8C9P0Q8",
            TownHall: "15",
            BuilderHall: "10",
            League: "Titan 1",
            ClanName: "ایرانیان قهرمان",
            StarsWar: "1360",
            GoldPass: "فعال",
            SuperTroops: "4 فعال",
            LinkedWith: "گوگل",
