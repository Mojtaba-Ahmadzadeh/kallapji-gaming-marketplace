...
const mockProducts = {
    'pubg-uc-660': {
        name: 'یوسی 660 پابجی',
        price: '295,000 تومان',
        oldPrice: '320,000 تومان',
        description: 'مناسب برای خرید اسکین‌ها، رویال پس و آیتم‌های ویژه در PUBG Mobile.',
        image: '/images/Gemini_Generated_Image_rp0wemrp0wemrp0w.jpeg',
    },
    'pubg-uc-1800': {
        name: 'یوسی 1800 پابجی',
        price: '720,000 تومان',
        oldPrice: '770,000 تومان',
        description: 'پک اقتصادی یوسی برای گیمرهای حرفه‌ای پابجی موبایل.',
        image: '/images/Gemini_Generated_Image_rp0wemrp0wemrp0w.jpeg',
    },
    'pubg-royale-pass': {
        name: 'رویال پس پریمیوم پابجی',
        price: '350,000 تومان',
        oldPrice: '390,000 تومان',
        description: 'دسترسی به جوایز فصل جدید، اسکین‌های انحصاری و XP بیشتر.',
        image: '/images/Gemini_Generated_Image_rp0wemrp0wemrp0w.jpeg',
    },
    'pubg-legendary-account': {
...
function ProductDetails({ params }) {
    ...
    const { slug } = params;  // اینجا به صورت مستقیم پارامتر رو میگیری
