...
const mockProducts = {
    'th15-max-hero-skin': {
        name: 'اکانت تاون هال 15 مکس',
        price: '1,800,000 تومان',
        oldPrice: '2,000,000 تومان',
        description: 'اکانت فول مکس با هیروهای کامل، پت‌ها و دیوارهای لول آخر. مناسب برای لیگ لجند.',
        image: '/images/Gemini_Generated_Image_1fogf71fogf71fog.png',
    },
    'th13-strong-account': {
        name: 'اکانت تاون هال 13 قوی',
        price: '1,200,000 تومان',
        oldPrice: '1,400,000 تومان',
        description: 'اکانتی قدرتمند با ساختمان‌ها و نیروهای پیشرفته. مناسب برای کلن وار.',
        image: '/images/clash_th13_strong.png',
    },
    'th11-mid-account': {
        name: 'اکانت تاون هال 11 متوسط',
        price: '850,000 تومان',
        oldPrice: '950,000 تومان',
        description: 'اکانت نیمه‌مکس با امکان پیشرفت سریع. گزینه‌ای اقتصادی برای شروع حرفه‌ای.',
        image: '/images/clash_th11_mid.png',
    },
    'th9-starter-account': {
        name: 'اکانت تاون هال 9 استارتر',
        price: '450,000 تومان',
        oldPrice: '500,000 تومان',
        description: 'مناسب برای شروع بازی با استراتژی‌های حرفه‌ای و وارهای سطح پایین.',
        image: '/images/clash_th9_starter.png',
    },
};
