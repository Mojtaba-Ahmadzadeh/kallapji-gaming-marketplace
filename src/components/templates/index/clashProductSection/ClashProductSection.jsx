    ...
    return (
        <div className="mt-16">
            ...
            <div className="flex items-center justify-between text-white mb-9 gap-4 overflow-x-auto whitespace-nowrap">
                ...
                <a href="/pages/cpKalaf.html" className="flex items-center gap-2 text-black dark:text-white bg-gray-200 dark:bg-[#151B2D] dark:hover:bg-[#1F263D] transition-colors duration-300 text-sm md:text-base font-Shabnam-Medium-FD px-6 md:px-8 py-3 md:py-3.5 rounded-full shadow hover:shadow-lg group shrink-0">
