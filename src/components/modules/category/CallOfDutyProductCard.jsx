...
function CallOfDutyProductCard() {
    return (
        <div className="group w-full p-4 rounded-3xl 
            ...
            <div className="relative overflow-hidden rounded-2xl">
                <a href="/pages/gameAccountDetails.html" className="block relative">
                    <img src="/images/Gemini_Generated_Image_f08nbsf08nbsf08n.jpeg" alt="اکانت کالاف دیوتی" className="w-full h-auto rounded-2xl object-cover 
                ...
                <div className="absolute top-1/2 left-3 -translate-y-1/2 flex flex-col gap-2 
                    ...
                    <button className="bg-white/80 dark:bg-[#1b1f33]/70 p-3 rounded-full shadow 
                        ...
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.318 6.318a4.5 4.5 0 016.364 0L12 7.636l1.318-1.318a4.5 4.5 0 116.364 6.364L12 20.364l-7.682-7.682a4.5 4.5 0 010-6.364z"></path>
                        </svg>
                    </button>
                    <button className="bg-white/80 dark:bg-[#1b1f33]/70 p-3 rounded-full shadow 
                                        text-gray-700 dark:text-white 
                                        ...
                                        transition duration-300">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 9m13-9l2 9m-9-3h4"></path>
                        </svg>
                    </button>
                </div>
            </div>
...
export default CallOfDutyProductCard