        ...
        >
            ...
            <div className="relative rounded-2xl overflow-hidden border border-gray-300 dark:border-[#1f2a58] shadow-inner">
                ...
                <div className="absolute top-1/2 left-3 -translate-y-1/2 flex flex-col gap-2 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    {/* Favorite Button */}
                    <button className="bg-white/70 dark:bg-[#1b1f33]/70 p-3 rounded-full shadow text-gray-800 dark:text-white hover:text-yellow-500 hover:scale-110 transition duration-300">
                    ...
                    <button className="bg-white/70 dark:bg-[#1b1f33]/70 p-3 rounded-full shadow text-gray-800 dark:text-white hover:text-emerald-500 hover:scale-110 transition duration-300">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 9m13-9l2 9m-9-3h4" />
                        </svg>
                    </button>
                </div>
            </div>
