...
function DesktopCategory() {
    return (
        <>
            ...
            <div class="relative w-52 font-Shabnam-Bold-FD text-slate-200 text-xs group">

                {/* Dropdown trigger button */}
                <div class="relative w-52 font-Shabnam-Bold-FD text-slate-800 dark:text-slate-200 text-xs group">

                    {/* Main dropdown button */}
                    <button class="w-full flex items-center justify-between bg-white/90 dark:bg-white/10 backdrop-blur-md rounded-xl px-4 py-2.5 shadow-lg transition hover:bg-yellow-100 dark:hover:bg-white/20">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div class="w-7 h-7 flex items-center justify-center 
                                ...
                                {/* Icon image */}
                                <img src="../images/icon-2.svg" alt="icon" class="w-4 h-4 dark:filter-none filter invert" />
                            </div>

                            {/* Label  */}
                            <span class="transition group-hover:text-yellow-600 dark:group-hover:text-yellow-400 text-slate-800 dark:text-slate-100 text-sm">
                                دسته‌بندی
                            </span>
                        </div>
                        {/* Dropdown arrow icon */}
                ...
                <div class="absolute top-14 right-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-3 rounded-lg w-56 z-50 transition-all text-slate-900 dark:text-white shadow-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-400/40 dark:ring-yellow-500/40 border border-yellow-300/30 dark:border-yellow-400/10">

                    {/* Dropdown items list */}
                    <ul class="space-y-1 text-white font-gamer text-sm custom-scroll">

                        {/* Mobile games item with sub-menu */}
                        <li class="relative group/sub">
                            <a href="#" class="flex items-center justify-between px-4 py-2 
                                ...
                                <div class="flex items-center gap-2">
                                    <FontAwesomeIcon icon={faGamepad}
                                        className="text-yellow-600 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-400/10 p-2 rounded-full w-7 h-7"
                                    />
                            ...
                            <div class="absolute top-0 right-[13.5rem] w-60 bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-3 rounded-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-500/40 border dark:border-yellow-400/10 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-300 z-50 max-h-[109px] overflow-y-auto custom-scroll">
                                <ul class="space-y-3 text-black dark:text-white text-sm">
                                    {/* Sub-menu items */}
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">کالاف
                                        دیوتی</a>
                                    </li>
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">پابجی</a>
                                    </li>
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">کلش
                                        آف کلنز</a>
                                    </li>
                                    <li><a href="./clashRoyale.html" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">کلش
                                        رویال</a>
                                    </li>
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">فورت
                                        نایت</a>
                                    </li>
                                    <li>
                                        <a href="#" class="
                                    ...
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">فری
                                        فایر</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="relative group/sub">
                            ...
                            <a href="#" class="flex items-center justify-between px-4 py-2 
                                ...
                                <div class="flex items-center gap-2">
                                    <FontAwesomeIcon icon={faTelegramPlane} className="text-yellow-600 dark:text-yellow-400 
                                        ...
                                        p-1.5 rounded-full text-xs w-6 h-6" />
                            ...
                            <div class="absolute top-0 right-[13.5rem] w-60 bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-3 rounded-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-500/40 border dark:border-yellow-400/10 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-300 z-50 max-h-[109px] overflow-y-auto custom-scroll">
                                <ul class="space-y-3 text-black dark:text-white text-sm">
                                    ...
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-300 transition-all">تلگرام
                                        پرمیوم</a>
                                    </li>
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-300 transition-all">استارز
                                        تلگرام</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="relative group/sub">
                            ...
                            <a href="#" class="flex items-center justify-between px-4 py-2 
                                ...
                                <div class="flex items-center gap-2">
                                    <FontAwesomeIcon icon={faGift} className=" text-yellow-600 dark:text-yellow-400 
                                        bg-yellow-100 dark:bg-yellow-400/10 w-6 h-6
                            ...
                            <div class="absolute top-0 right-[13.5rem] w-60 bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-3 rounded-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-500/40 border dark:border-yellow-400/10 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-300 z-50 max-h-[109px] overflow-y-auto custom-scroll">
                                <ul class="space-y-3 text-black dark:text-white text-sm">
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">گیفت
                                        کارت
                                        اسپاتیفای</a>
                                    </li>
                                    <li><a href="#" class="block hover:text-yellow-600 dark:hover:text-yellow-400 transition-all">گیفت
                        ...
                        <li>
                            <a href="./register-ad.html" class="flex items-center justify-between px-4 py-2 
                                text-slate-800 dark:text-white 
                                hover:text-yellow-600 dark:hover:text-yellow-300 
                                transition-all rounded-lg">
            ...
            {/* Separator line */}
            <span class="bg-gray-500 w-[1px] h-[1.5rem] mt-[0.6rem]"></span>

            {/*  Main horizontal navigation */}
            <div>
                {/* Each <li> here is a navigation item  */}
                <ul class="hidden lg:flex flex-wrap gap-x-7 items-center">
                    {/* Example: PUBG */}
                    <li>
                        <a
                    ...
                    <li>
                        <a href="/pages/giftCard.html" class="flex items-center gap-x-2 text-slate-800 dark:text-white hover:text-pink-500 dark:hover:text-pink-400 transition">
                    ...
                    <li>
                        <a
                            ...
                            className="flex items-center gap-x-2 text-slate-800 hover:text-[#0088cc] transition group"
                        >
                            <FontAwesomeIcon
                                icon={faTelegram}
                    ...
                    <li>
                        <a href="/pages/ClashOfClans.html" class="flex items-center gap-x-2 text-slate-800 dark:text-white hover:text-orange-500 dark:hover:text-orange-400 transition">
                    ...
                    <li class="relative group">
                        ...
                        <a href="#" class="flex items-center gap-x-2 text-slate-800 dark:text-white hover:text-blue-400 transition">
                            <FontAwesomeIcon icon={faEnvelope} className="text-blue-400 w-4 h-4" />
                            <span>ارتباط با ما</span>
                            <i class="fas fa-chevron-down text-sm text-gray-500 dark:text-gray-300"></i>
                        </a>
                        <div class="absolute top-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-5 rounded-lg w-56 z-50 transition-all text-slate-900 dark:text-white shadow-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-400/40 dark:ring-yellow-500/40 border border-yellow-300/30 dark:border-yellow-400/10">
                            <ul class="text-sm space-y-3 font-gamer">
                                <li>
                                ...
                                <li>
                                    <a href="/pages/rules.html" class="flex items-center gap-x-2 hover:text-yellow-600 dark:hover:text-yellow-400 transition duration-200">
                                ...
                                <li>
                                    <a href="/pages/questions.html" class="flex items-center gap-x-2 hover:text-yellow-600 dark:hover:text-yellow-400 transition duration-200">
                    ...
                    <li class="relative group">
                        <a href="#" class="flex items-center gap-x-2 text-slate-800 dark:text-white hover:text-cyan-500 dark:hover:text-cyan-400 transition">
                            <FontAwesomeIcon icon={faUserCircle} className="text-cyan-400 w-4 h-4" />
                            <span>حساب کاربری</span>
                            <FontAwesomeIcon icon={faChevronDown} className="text-sm text-gray-500 dark:text-gray-300 w-4 h-4" />
                        </a>
                        <div class="absolute top-8 -right-9 opacity-0 invisible group-hover:opacity-100 group-hover:visible bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-5 rounded-lg w-56 z-50 transition-all text-slate-900 dark:text-white shadow-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-400/40 dark:ring-yellow-500/40 border border-yellow-300/30 dark:border-yellow-400/10">

                            <div class="flex items-center gap-3 border-b border-yellow-400/40 pb-3 mb-3">
                                <img src="https://secure.gravatar.com/avatar/221d58ad75e354575e6ded2ee3a6e1a2?s=96&amp;d=mm&amp;r=g" alt="نام کاربر" class="w-10 h-10 rounded-full object-cover" loading="lazy" />
                                <div class="text-sm font-gamer tracking-tight">
                                    <span>نام کاربر</span>
                                </div>
                            </div>
                            ...
                            <ul class="text-sm space-y-3 font-gamer">
                                <li>
                                    <a href="/pages/p-user.html" class="flex items-center gap-x-2 hover:text-yellow-600 dark:hover:text-yellow-400 transition duration-200">
                                ...
                                <li>
                                    <a href="/pages/registered-comments.html" class="flex items-center gap-x-2 hover:text-yellow-600 dark:hover:text-yellow-400 transition duration-200">
                                ...
                                <li>
                                    <a href="/pages/favorites.html" class="flex items-center gap-x-2 hover:text-yellow-600 dark:hover:text-yellow-400 transition duration-200">
