...
function ThemeToggle() {
    return (
        <>
            <div id="toggle-theme" class="block relative cursor-pointer transition-colors text-gray-800 dark:text-white hover:text-yellow-500 dark:hover:text-gray-300">
