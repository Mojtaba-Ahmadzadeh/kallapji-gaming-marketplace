            ...
            <div id="user-menu-mobile" className="absolute top-10 right-[-9rem] opacity-0 invisible group-hover:opacity-100 group-hover:visible bg-gradient-to-br from-yellow-100 via-yellow-50 to-yellow-100/70 dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:via-[#2b2b2b]/80 dark:to-[#facc15]/25 p-5 rounded-lg w-56 z-50 transition-all text-slate-900 dark:text-white shadow-lg dark:shadow-[0_4px_30px_rgba(250,204,21,0.4)] backdrop-blur-lg ring-1 ring-yellow-400/40 dark:ring-yellow-500/40 border border-yellow-300/30 dark:border-yellow-400/10">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 border-b border-yellow-400/40 pb-3 mb-3">
                        ...
                        <div className="text-lg font-gamer tracking-tight antialiased"><span>نام کاربر</span></div>
                    </div>
                    <ul className="text-sm space-y-3 font-gamer antialiased">
                        <li><a href="/pages/p-user.html" className="flex items-center gap-x-2 text-lg hover:text-yellow-600 dark:hover:text-yellow-300 transition-all"><i className="fas fa-gauge"></i><span>پیشخوان</span></a></li>
                        <li><a href="/pages/orders.html" className="flex items-center gap-x-2 text-lg hover:text-yellow-600 dark:hover:text-yellow-300 transition-all"><i className="fas fa-shopping-cart"></i><span>سفارشات</span></a></li>
                        <li><a href="/pages/tickets.html" className="flex items-center gap-x-2 text-lg hover:text-yellow-600 dark:hover:text-yellow-300 transition-all"><i className="fas fa-ticket-alt"></i><span>تیکت‌ها</span></a></li>
                        <li><a href="/pages/comments.html" className="flex items-center gap-x-2 text-lg hover:text-yellow-600 dark:hover:text-yellow-300 transition-all"><i className="fas fa-comments"></i><span>کامنت‌ها</span></a></li>
                        <li><a href="/pages/favorites.html" className="flex items-center gap-x-2 text-lg hover:text-yellow-600 dark:hover:text-yellow-300 transition-all"><i className="fas fa-heart"></i><span>علاقه‌مندی‌ها</span></a></li>
                        <li><a href="/pages/p-user.html" className="flex items-center gap-x-2 text-lg hover:text-yellow-600 dark:hover:text-yellow-300 transition-all"><i className="fas fa-user-cog"></i><span>جزییات اکانت</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
