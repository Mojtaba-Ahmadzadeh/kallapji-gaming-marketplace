...
function LogoAndTitle() {
    return (
        ...
        <div className="flex items-center gap-2 sm:gap-3 group cursor-pointer transition-all duration-300">
            ...
            <a
                href="./index.html"
                className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 rounded-lg overflow-hidden shadow-lg ring-1 ring-violet-500/30 group-hover:scale-105 transition-transform duration-300 bg-white"
            >
                <img
                    src="../images/logo.png"
                    alt="لوگو فروشگاه"
