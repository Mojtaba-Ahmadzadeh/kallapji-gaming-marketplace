  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: '#f59e0b',
        'primary-dark': '#E55946',
        'secondary-dark': '#E63A77',
        card: '#1e293b',
        background: '#0f172a',
      },
      fontFamily: {
        sans: ['Shabnam', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
      ...
      animation: {
        ...
        'fade-in-card': 'fade-in-up 0.6s ease-out forwards',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
